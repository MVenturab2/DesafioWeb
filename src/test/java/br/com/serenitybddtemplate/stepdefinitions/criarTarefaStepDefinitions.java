...
public class criarTarefaStepDefinitions {
    ...
    public void selecionarTarefaCriada( ){
        minhaVisaoSteps.clicarTarefaCriada();
    }

    @And("apago a tarefa")
    public void apagarTarefa(){
        minhaVisaoSteps.clicarEmApagarTarefa();
        minhaVisaoSteps.clicarEmConfirmarApagarTarefa();
    }
    @And("^situação da tarefa se encontra '(.*)' na tela de ver tarefas$")
    ...
    @And("^sistema apresenta o estado da tarefa como '(.*)'$")
