...
public class GerenciarProjetosSteps {
    ...
    @Step("Gerenciar Projetos: selecionar SubProjeto")
    ...
    @Step("Gerenciar Projetos: preencher Nome Da Versao Do Projeto")
    ...
    // Categorias Globais
    @Step("Gerenciar Projetos: preencher Nome Categoria Global")
    public void preencherNomeCategoriaGlobal(String nome){
        gerenciarProjetosPage.preencherNomeCategoriaGlobal(nome);
    }
    @Step("Gerenciar Projetos: preencher Nome Categoria Global na edição do projeto")
    ...
    @Step("Gerenciar Projetos: selecionar Usuario atribuido a Categoria Global")
