package br.com.serenitybddtemplate.bases;
...
public class PageBase extends PageObject {
    ...
    protected WebDriverWait wait1Sec = null;
    ...
    public PageBase(WebDriver driver){
        ...
        this.wait1Sec = new WebDriverWait(driver,0, 500);
    ...
    protected WebElement waitForElementFor1Sec(By locator){
        waitUntilPageReady();
        wait1Sec.until(ExpectedConditions.presenceOfElementLocated(locator));
        WebElement element = driver.findElement(locator);
        wait1Sec.until(ExpectedConditions.elementToBeClickable(element));
        return element;
    }
    ...
    protected void clickWait1sec(By locator){
        WebDriverException possibleWebDriverException = null;
        StopWatch timeOut = new StopWatch();
        timeOut.start();
        ...
        while (timeOut.getTime() <= timeOutDefault)
        {
            ...
            try
            {
                element = waitForElementFor1Sec(locator);
                element.click();
                timeOut.stop();
                return;
            }
    ...
    protected boolean returnComboBoxByVisibleText(By locator, String text){
        Select comboBox = new Select(waitForElement(locator));
        try {
            comboBox.selectByVisibleText(text);
            return true;
    ...
    protected boolean returnIfElementExistsLowTimeout(By locator){
        boolean result = false;
        try
        {
            wait1Sec.until(ExpectedConditions.presenceOfElementLocated(locator));
