...
public class GerenciarProjetosPage extends PageBase {
    ...
    //menus
    By criarNovoProjetoButton = By.cssSelector("button.btn.btn-primary.btn-white.btn-round");// css=button.btn.btn-primary.btn-white.btn-round

    By projetoCriadoButton = null;

    By todosProjetosCriadosButton = By.linkText("Todos os Projetos");
    By apagarProjetoButton = By.xpath("//input[@value='Apagar Projeto']");  /// css=input.btn.btn-primary.btn-sm.btn-white.btn-round
